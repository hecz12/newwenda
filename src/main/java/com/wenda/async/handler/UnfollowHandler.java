...
public class UnfollowHandler implements EventHandler {
    ...
    public void dohandle(EventModel eventModel) {
        ...
        message.setToId(eventModel.getEntityId());
        if(eventModel.getEntityType()== EntityType.TYPE_QUESTION) {
            message.setContent( eventModel.getExt("username") +
                    "取消了对您的问题"+eventModel.getExt("quetionName")+
                    "的关注，链接是:http://localhost:8080/quetion/"
